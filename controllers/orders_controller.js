...
const { sendEmailToUser } = require("../middlewares/nodeMailer_Purchase")
    ...
    addNewOrderForGuest: async (req,res) => {
        ...
        try {
           console.log(req.body)
            ...
            sendEmailToUser(customer_details.customer_email,customer_details.customer_name,products,payment_details.transaction_number)
