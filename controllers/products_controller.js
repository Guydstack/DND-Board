...
const defaultImage = "https://res.cloudinary.com/doxiillcn/image/upload/v1706728686/samples/logo.png"
...
module.exports = {
  ...
  getByIdForManager: async (req, res) => {
    try {
      const models = await Model.findById(req.params.product_id).populate("categories").exec();
